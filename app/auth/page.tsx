...
export default function AuthPage() {
  ...
  return (
    <div className="min-h-screen bg-surface flex flex-col md:flex-row">
      ...
      {/* Right Side - Form */}
      <div className="flex-1 flex flex-col items-center justify-center relative px-5 py-8 md:p-8 lg:p-12">
        ...
        <div className="z-10 w-full max-w-md animate-fade-in-up">
          ...
          <div className="flex flex-col items-center mb-8 md:hidden">
            <div className="w-20 h-20 rounded-full bg-primary-container flex items-center justify-center shadow-lg mb-4">
              <span
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            {!isLogin && (
              <div className="animate-fade-in">
                ...
                <input
                  ...
                  className="w-full px-4 py-3 rounded-xl bg-surface-container border border-surface-variant text-on-surface placeholder:text-on-surface-variant focus:outline-none focus:border-primary focus:ring-2 focus:ring-primary/20 transition-all font-body-md"
                  required={!isLogin}
                />
              </div>
            )}
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="w-full py-4 rounded-xl bg-primary text-on-primary font-label-md text-label-md shadow-lg hover:bg-primary-container hover:text-on-primary-container transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
            >
              {isLoading ? (
                <>
          ...
          <div className="grid grid-cols-2 gap-4">
            <GlassCard className="flex items-center justify-center gap-2 py-3 rounded-xl hover:bg-surface-container transition-colors cursor-pointer">
          ...
          {/* Toggle */}
          <p className="text-center mt-6 md:mt-8 font-body-md text-body-md text-on-surface-variant">
